        ...
        <section id="home" className="hero">
            <div className="hero-left">
                <div className="radio-card" role="img" aria-label="Shortwave Transceiver">
                    ...
                    <svg viewBox="0 0 800 450" preserveAspectRatio="xMidYMid meet" className="transceiver-svg">
                            ...
                            <g fill="#8b6f5e" opacity="0.9">
                                {Array.from({ length: 11 }).map((_, row) =>
                                    Array.from({ length: 20 }).map((_, col) => (
                                        <circle key={`${row}-${col}`} cx={20 + col * 20} cy={10 + row * 10} r="2" />
                                    ))
                                )}
                            </g>
                        </g>
                        ...
                        <g transform="translate(520,80)">
                            ...
                            <text x="60" y="25" fontSize="15" fill="#4a2f26">5</text>
                            <text x="80" y="25" fontSize="15" fill="#4a2f26">7</text>
                            <text x="100" y="25" fontSize="15" fill="#4a2f26">9</text>
                            <text x="115" y="25" fontSize="15" fill="#4a2f26">+20</text>
                            ...
                            <g transform="translate(20,20)">
                                {["AGC", "NB", "NR", "MODE", "VFO", "TUNER"].map((txt, i) => (
                                    <g key={txt} transform={`translate(${i * 110},0)`}>
                                        <rect x="-20" y="0" width="90" height="46" rx="6" fill="#e9d6bf" stroke="#4a2f26" />
                                        <text x="25" y="30" textAnchor="middle" fontSize="18" fill="#4a2f26">{txt}</text>
                                    </g>
                                ))}
                            </g>
                ...
                <div className="hero-info">
                    ...
                    <p className="muted">Shortwave enthusiasts of Tallinn — events, schedules, live QSO and workshops.</p>
                    <Player />
                    <p className="muted">Broadcasting from the heart of Tallinn, our club brings together radio enthusiasts, operators, and curious minds who share a love for the airwaves. Whether you're tuning in from across the city or across the world, you're part of our frequency.</p>
